...
hl.window_rule({match = {title = "^(Article Reader)(.*)$" },                 float = true})
hl.window_rule({match = {title = "^(Article Reader)(.*)$" },                 center = true})
hl.window_rule({match = {title = "^(Article Reader)(.*)$" },                 size = {"(monitor_w*0.52)", "(monitor_h*0.85)"} })
hl.window_rule({match = {title = "^(Service Launcher)(.*)$" },               float = true})
hl.window_rule({match = {title = "^(Service Launcher)(.*)$" },               center = true})
hl.window_rule({match = {title = "^(Service Launcher)(.*)$" },               size = {"(monitor_w*0.42)", "(monitor_h*0.5)"} })
hl.window_rule({match = {title = "^(Homelab Glance)(.*)$" },                 float = true})
hl.window_rule({match = {title = "^(Homelab Glance)(.*)$" },                 center = true})
hl.window_rule({match = {title = "^(Homelab Glance)(.*)$" },                 size = {"(monitor_w*0.36)", "(monitor_h*0.6)"} })
hl.window_rule({match = {title = "^(Recon Launcher)(.*)$" },                 float = true})
hl.window_rule({match = {title = "^(Recon Launcher)(.*)$" },                 center = true})
hl.window_rule({match = {title = "^(Recon Launcher)(.*)$" },                 size = {"(monitor_w*0.4)", "(monitor_h*0.45)"} })
hl.window_rule({match = {title = "^(Text Actions)(.*)$" },                   float = true})
hl.window_rule({match = {title = "^(Text Actions)(.*)$" },                   center = true})
hl.window_rule({match = {title = "^(Text Actions)(.*)$" },                   size = {"(monitor_w*0.42)", "(monitor_h*0.5)"} })
hl.window_rule({match = {title = "^(Printers)(.*)$" },                       float = true})
hl.window_rule({match = {title = "^(Printers)(.*)$" },                       center = true})
hl.window_rule({match = {title = "^(Printers)(.*)$" },                       size = {"(monitor_w*0.42)", "(monitor_h*0.5)"} })
