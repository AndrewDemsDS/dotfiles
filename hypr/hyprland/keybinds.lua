...
hl.bind("SUPER + ALT + I", hl.dsp.exec_cmd(qsIpcCall .. " localLlm toggle"),
    { description = "Utilities: AI text actions (local Ollama)" })
hl.bind("SUPER + ALT + H", hl.dsp.exec_cmd(qsIpcCall .. " homeAssistant dashboard"),
    { description = "Apps: Home Assistant dashboard" })
hl.bind("SUPER + ALT + L", hl.dsp.exec_cmd(qsIpcCall .. " serviceLauncher toggle"),
    { description = "Apps: Service launcher" })
hl.bind("SUPER + ALT + G", hl.dsp.exec_cmd(qsIpcCall .. " homelabGlance toggle"),
