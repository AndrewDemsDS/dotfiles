...
hl.window_rule({match = {title = "^(Secrets)$" },                            float = true})
hl.window_rule({match = {title = "^(Secrets)$" },                            center = true})
hl.window_rule({match = {title = "^(Secrets)$" },                            size = {"(monitor_w*0.3)", "(monitor_h*0.5)"} })
